...
def crystalShipDialogue():
    print("The Crawling King Snake takes you to a small wooden dock.\nOn the very end of the dock, a rusty old car with no wheels is parked in the shallow water.\nAs you come closer, you see three muddy, brown frogs sitting inside the car. The driver-frog is wearing glasses.\n")
    time.sleep(15)
    print("The one frog sitting in the back says: 'Hey man... get in.'\n")
    time.sleep(5)
...
print("!!!\nDISCLAIMER: You might have a better experience with the use of imagination and read carefully!\n!!!\n")
time.sleep(8)
