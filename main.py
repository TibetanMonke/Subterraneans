...
answer1 = "1"
if answer1 == "1":
    print("The Crawling King Snake says: 'Ah, you are one of those, a stranger from the top of the soil. Well, as long as you don't disturb our peace, we won't bother you.'")
